    ...
    public static class GlyphFixer
    {
        ...
        public static void FixYah(FastStringBuilder text, bool farsi)
        {
            for (int i = 0; i < text.Length; i++)
            {
                ...
                else if (farsi == false && text.Get(i) == (int)ArabicGeneralLetters.Bariyey)
                {
                    text.Set(i, (char)ArabicGeneralLetters.Bariyey);
                }
            }
        }
        ...
        private static bool IsLeadingLetter(FastStringBuilder letters, int index)
        {
            ...
            bool isPreviousLetterNonConnectable = index == 0 ||
                                                  ...
                                                  previousIndexLetter == (int)ArabicGeneralLetters.Ddal ||
                                                  previousIndexLetter == (int)ArabicGeneralLetters.Thal ||
                                                  previousIndexLetter == (int)ArabicGeneralLetters.Reh ||
                                                  previousIndexLetter == (int)ArabicGeneralLetters.Rreh ||
                                                  ...
                                                  previousIndexLetter == (int)ArabicIsolatedLetters.Ddal ||
                                                  previousIndexLetter == (int)ArabicIsolatedLetters.Thal ||
                                                  previousIndexLetter == (int)ArabicIsolatedLetters.Reh ||
                                                  previousIndexLetter == (int)ArabicIsolatedLetters.Rreh ||
                                                  ...
                                                  previousIndexLetter == (int)ArabicGeneralLetters.Bariyey &&
                                                  previousIndexLetter == (int)ArabicGeneralLetters.Noongunna &&
            ...
            bool canThisLetterBeLeading = currentIndexLetter != ' ' &&
                                          ...
                                          currentIndexLetter != (int)ArabicGeneralLetters.Ddal &&
                                          currentIndexLetter != (int)ArabicGeneralLetters.Thal &&
                                          currentIndexLetter != (int)ArabicGeneralLetters.Reh &&
                                          currentIndexLetter != (int)ArabicGeneralLetters.Rreh &&
                                          ...
                                          currentIndexLetter != (int)ArabicGeneralLetters.Bariyey &&
                                          currentIndexLetter != (int)ArabicGeneralLetters.Noongunna &&
