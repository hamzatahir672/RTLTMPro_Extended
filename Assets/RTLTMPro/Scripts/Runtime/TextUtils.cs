...
namespace RTLTMPro
{
    public static class TextUtils
    {
        ...
        public static bool IsGlyphFixedArabicCharacter(char ch)
        {
            ...
            if (ch >= (char)ArabicIsolatedLetters.Tteh &&
    ch <= (char)ArabicIsolatedLetters.Tteh + 3)
            {
                return true;
            }

            if (ch >= (char)ArabicIsolatedLetters.Ddal && ch <= (char)ArabicIsolatedLetters.Ddal + 1)
            {
                return true;
            }

            if (ch >= (char)ArabicIsolatedLetters.Rreh && ch <= (char)ArabicIsolatedLetters.Rreh + 1)
            {
                return true;
            }

            if (ch >= (char)ArabicIsolatedLetters.Bariyey &&
    ch <= (char)ArabicIsolatedLetters.Bariyey + 3)
            {
                return true;
            }

            if (ch >= (char)ArabicIsolatedLetters.Noongunna && ch <= (char)ArabicIsolatedLetters.Noongunna + 1)
            {
                return true;
            }

            if (ch >= (char)ArabicIsolatedLetters.UrduHeh && ch <= (char)ArabicIsolatedLetters.UrduHeh + 3)
            {
                return true;
            }

            //if (ch >= (char)ArabicIsolatedLetters.Hehdochasmi && ch <= (char)ArabicIsolatedLetters.Hehdochasmi + 3)
            //{
            //    return true;
            //}
            ...
            switch (ch)
            {
                ...
                case (char)ArabicGeneralLetters.Tteh:
                case (char)ArabicGeneralLetters.Ddal:
                case (char)ArabicGeneralLetters.Rreh:
                case (char)ArabicGeneralLetters.Bariyey:
                case (char)ArabicGeneralLetters.Hehdochasmi:
                case (char)ArabicGeneralLetters.Noongunna:
                case (char)ArabicGeneralLetters.UrduHeh:
